...
<head>
	...
	<script src="js/load_backup_vps.js"></script>
</head>
	...
	<header id="header">
		<div class="content">
			...
			<ul class="actions">
				...
				<form id="statusData" enctype="multipart/form-data">
					<input type="submit" name="p0t4t0" id="p0t4t0" value="DOWNLOAD .ZIP"/>
				</form>
