	...
	<header id="header">
		<div class="content">
			...
			<ul class="actions">
				...
				<form id="statusCer" enctype="multipart/form-data">
					<input type="submit" name="p0t4t0" id="p0t4t0" value="DOWNLOAD .CER"/>
				</form>
				<form id="statusKey" enctype="multipart/form-data">
					<input type="submit" name="p0t4t0" id="p0t4t0" value="DOWNLOAD .KEY"/>
				</form>
