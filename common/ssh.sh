...
cd /etc/ssh
rm -f sshd_config
curl -k -O https://raw.githubusercontent.com/jie-vpn/scriptvpn/master/common/sshd_config
chmod 777 sshd_config
curl -L -k --silent -o /etc/banner.com "https://github.com/jie-vpn/scriptvpn/raw/master/banner/banner.com"
service ssh restart
